...
- App privacy: **Data Not Collected**, published in App Store Connect with the developer's approval on September 23, 2026. There are no developer-side telemetry, analytics, ads, cloud inference, or user accounts. Transfers are only between the user's paired devices. Apple diagnostics and voluntarily submitted public GitHub issues are described in the policy.
...
- Initial target: iPhone. Mac Catalyst, iOS-on-Mac and visionOS compatibility are disabled in project settings. The corresponding Mac and Apple Vision Pro availability switches are also disabled and saved in App Store Connect.
